    ...
    function updateLogs() {
      ...
      chrome.storage.local.get("trackedData", (data) => {
        ...
        sortedData.forEach(({ site, count, size, metric }) => {
            ...
            if (site == "degiehkbeeeoefgjcoogpfbhegcoieko") {
